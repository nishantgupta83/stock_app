# Learning snapshot — end of 2026-06

_Generated 2026-06-03 from a historical replay of stock_event_paper_trades through 2026-06-30._
...
| Positions open | 0 / 5 |
| Cumulative PnL | $550.36 |
| Return % (vs $5K base) | +11.01% |
| High-water mark | $906.28 |
| Max drawdown | $580.19 (+11.60%) |
| Closed trades | 220 (111W / 109L, win-rate 50.5%) |
| Avg PnL per closed trade | $2.50 |
...
## Mature rules (n ≥ 30) as of 2026-06-30
...
This is a *historical replay*, not a live trading record. It answers the question: *had the realistic_loop_agent been active with a $5K bankroll and the discipline we ship today, what would it have made by 2026-06?* Numbers are bounded by the corpus available — h7d horizon, severity ≥ 2 events, ~150-ticker universe. They do not reflect intraday-spike alerts or the maturity-gated BUY/SELL vocabulary (which never triggered during this period — no rule reached the 90%/n≥30 adult gate).
