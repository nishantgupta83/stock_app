# Monthly reconciliation — 2025-09
...
|---|---|---|
| Deposits | $2,500.00 | $11,000.00 |
| Trading PnL | -$92.82 | -$191.25 |
| Opens | 29 | 133 |
| Closes | 29 | 124 |
| Win-rate | 51.7% | 49.2% |
| Skipped (rule banned) | 0 | n/a |
| Flipped-direction trades opened | 7 | n/a |

| Snapshot | Value |
|---|---|
| Cash idle | $6,500.00 |
| Deployed in positions | $4,500.00 (9/10) |
| Cumulative PnL | -$191.25 |
| **Total equity** | **$10,808.75** |
| Return on deposits | -1.74% |
| Max drawdown | $522.88 |
