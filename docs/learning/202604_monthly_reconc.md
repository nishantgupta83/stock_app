# Monthly reconciliation — 2026-04
...
|---|---|---|
| Deposits | $2,000.00 | $26,000.00 |
| Trading PnL | $565.29 | $228.35 |
| Opens | 41 | 360 |
| Closes | 34 | 350 |
| Win-rate | 64.7% | 50.3% |
| Skipped (rule banned) | 0 | n/a |
| Flipped-direction trades opened | 9 | n/a |

| Snapshot | Value |
|---|---|
| Cash idle | $21,000.00 |
| Deployed in positions | $5,000.00 (10/10) |
| Cumulative PnL | $228.35 |
| **Total equity** | **$26,228.35** |
| Return on deposits | +0.88% |
| Max drawdown | $575.73 |
