...
| [`2026-06-12_e2e-review.md`](2026-06-12_e2e-review.md) | 2026-06-12 | **Criticals DONE; H/M/L backlog** | End-to-end review. C1 (calibration ratchet) + C2 (maturity-gate scope + PF-lag) + C3 (swallowed errors) shipped + validated; H3 also done. Open: H1 effective-n, H2 after-hours anchor, H4 display drift, H5 retry lane-scope, H6 risk pagination, H7 watchdog; M1–M8; Lows. M2/M3 are preconditions for the 2026-07-06 funnel re-run. |
